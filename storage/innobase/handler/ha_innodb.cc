  ...
  switch (dict_recovery_mode) {
    ...
    case DICT_RECOVERY_INITIALIZE_SERVER:
      ...
      dict_sys->vector_truth_prepared = dd_table_open_on_name(
          ...
          DICT_ERR_IGNORE_NONE);
      dict_sys->vector_publication_intents = dd_table_open_on_name(
          thd, nullptr, "mysql/vector_index_publication_intents", false,
          DICT_ERR_IGNORE_NONE);
...
static bool innobase_ddse_dict_init(
  ...
  */
  ...
  tables->push_back(&dd::tables::Vector_index_publication_intents::instance());
