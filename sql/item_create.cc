...
#include "sql/vector/item_vectorfunc.h"   // Item_func_vec_distance_euclidean
#endif
...
static const std::pair<const char *, Create_func *> func_array[] = {
...
#ifdef HAVE_VECTOR_INDEX
    {"VEC_DISTANCE_COSINE", SQL_FN(Item_func_vec_distance_cosine, 2)},
    {"VEC_DISTANCE", SQL_FN_V_LIST(Item_func_vec_distance, 2, 3)},
    {"VEC_DISTANCE_EUCLIDEAN", SQL_FN(Item_func_vec_distance_euclidean, 2)},
    {"VEC_DOT_PRODUCT", SQL_FN(Item_func_vec_dot_product, 2)},
    {"VEC_INNER_PRODUCT", SQL_FN(Item_func_vec_inner_product, 2)},
    {"VEC_FROMTEXT", SQL_FN(Item_func_vec_fromtext, 1)},
#ifndef NDEBUG
    {"VEC_DEBUG_TRUTH_STORE_GET_HEX",
     SQL_FN_V_LIST(Item_func_vec_debug_truth_store_get_hex, 1, 1)},
    ...
    {"VEC_INDEX_SET_FAISS_IVF_PARAMS",
     SQL_FN_V_LIST(Item_func_vec_index_set_faiss_ivf_params, 3, 3)},
    {"VEC_INDEX_SET_FAISS_IVFPQ_PARAMS",
     SQL_FN_V_LIST(Item_func_vec_index_set_faiss_ivfpq_params, 5, 5)},
    {"VEC_INDEX_SET_DISKANN_BUILD_PARAMS",
     SQL_FN_V_LIST(Item_func_vec_index_set_diskann_build_params, 3, 4)},
    {"VEC_INDEX_SET_DISKANN_BUILD_MODE",
     SQL_FN(Item_func_vec_index_set_diskann_build_mode, 2)},
    {"VEC_INDEX_SET_DISKANN_SEARCH_COMPLEXITY",
     SQL_FN(Item_func_vec_index_set_diskann_search_complexity, 2)},
    {"VEC_INDEX_SET_DISKANN_SEARCH_BEAMWIDTH",
     SQL_FN(Item_func_vec_index_set_diskann_search_beamwidth, 2)},
    {"VEC_INDEX_SET_DISKANN_PQ_CODE_BUDGET_SIZE",
     SQL_FN(Item_func_vec_index_set_diskann_pq_code_budget_size, 2)},
    {"VEC_INDEX_SET_DISKANN_DISK_PQ_DIMS",
     SQL_FN(Item_func_vec_index_set_diskann_disk_pq_dims, 2)},
    {"VEC_INDEX_SET_DISKANN_ACCELERATE_BUILD",
     SQL_FN(Item_func_vec_index_set_diskann_accelerate_build, 2)},
    {"VEC_INDEX_SET_DISKANN_SHUFFLE_BUILD",
     SQL_FN(Item_func_vec_index_set_diskann_shuffle_build, 2)},
    {"VEC_INDEX_SET_DISKANN_USE_BFS_CACHE",
     SQL_FN(Item_func_vec_index_set_diskann_use_bfs_cache, 2)},
    {"VEC_INDEX_SET_SEARCH_EF",
     SQL_FN(Item_func_vec_index_set_search_ef, 2)},
    {"VEC_INDEX_DROP", SQL_FN_V_LIST(Item_func_vec_index_drop, 1, 1)},
    {"VEC_INDEX_ERASE", SQL_FN_V_LIST(Item_func_vec_index_erase, 2, 2)},
    {"VEC_INDEX_INFO", SQL_FN_V_LIST(Item_func_vec_index_info, 1, 1)},
    {"VEC_INDEX_LIST", SQL_FN(Item_func_vec_index_list, 0)},
    {"VEC_INDEX_BULK_BUILD",
     SQL_FN_V_LIST(Item_func_vec_index_bulk_build, 1, 1)},
    {"VEC_INDEX_BULK_LOAD_BEGIN",
     SQL_FN_V_LIST(Item_func_vec_index_bulk_load_begin, 1, 1)},
    {"VEC_INDEX_REBUILD", SQL_FN_V_LIST(Item_func_vec_index_rebuild, 1, 1)},
    {"VEC_INDEX_RECOVER", SQL_FN_V_LIST(Item_func_vec_index_recover, 1, 1)},
    {"VEC_INDEX_REBUILD_ALL", SQL_FN(Item_func_vec_index_rebuild_all, 0)},
    {"VEC_INDEX_RECOVER_ALL", SQL_FN(Item_func_vec_index_recover_all, 0)},
    {"VEC_INDEX_SEARCH", SQL_FN_V_LIST(Item_func_vec_index_search, 3, 3)},
    {"VEC_INDEX_SEARCH_BATCH",
     SQL_FN_V_LIST(Item_func_vec_index_search_batch, 4, 4)},
    {"VEC_INDEX_SEARCH_WITH_DISTANCE",
     SQL_FN_V_LIST(Item_func_vec_index_search_with_distance, 3, 3)},
    {"VEC_INDEX_STAGE_ERASE",
     SQL_FN_V_LIST(Item_func_vec_index_stage_erase, 3, 3)},
    {"VEC_INDEX_STAGE_UPSERT",
     SQL_FN_V_LIST(Item_func_vec_index_stage_upsert, 4, 4)},
    {"VEC_INDEX_TXN_BEGIN", SQL_FN(Item_func_vec_index_txn_begin, 0)},
    {"VEC_INDEX_TXN_COMMIT",
     SQL_FN_V_LIST(Item_func_vec_index_txn_commit, 1, 1)},
    {"VEC_INDEX_TXN_PENDING",
     SQL_FN_V_LIST(Item_func_vec_index_txn_pending, 1, 1)},
    {"VEC_INDEX_TXN_ROLLBACK",
     SQL_FN_V_LIST(Item_func_vec_index_txn_rollback, 1, 1)},
    {"VEC_INDEX_TXN_ROLLBACK_TO",
     SQL_FN_V_LIST(Item_func_vec_index_txn_rollback_to, 2, 2)},
    {"VEC_INDEX_TXN_SAVEPOINT",
     SQL_FN_V_LIST(Item_func_vec_index_txn_savepoint, 2, 2)},
    {"VEC_INDEX_TXN_RELEASE_SAVEPOINT",
     SQL_FN_V_LIST(Item_func_vec_index_txn_release_savepoint, 2, 2)},
    {"VEC_INDEX_UPSERT", SQL_FN_V_LIST(Item_func_vec_index_upsert, 3, 3)},
    {"VEC_INDEX_UPSERT_BATCH",
     SQL_FN_V_LIST(Item_func_vec_index_upsert_batch, 4, 4)},
    {"VEC_NORMALIZE", SQL_FN(Item_func_vec_normalize, 1)},
    {"VEC_TOTEXT", SQL_FN(Item_func_vec_totext, 1)},
